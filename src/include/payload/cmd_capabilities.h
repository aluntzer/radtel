/**
 * @file    include/payload/cmd_capabilities.h
 ...
 * more details.
 *
 * @brief payload structure for CMD_CAPABILITIES
 *
 */

#ifndef _INCLUDE_PAYLOAD_CMD_CAPABILITIES_H_
#define _INCLUDE_PAYLOAD_CMD_CAPABILITIES_H_
 ...
 *
 * CMD_CAPABILITIES packet payload structure
 *
 */
...
#endif /* _INCLUDE_PAYLOAD_CMD_CAPABILITIES_H_ */
